...
1. Follow [**Implementation Steps**](./polymarket-implementation-steps.md) - Step-by-step integration
2. Reference [**API Documentation**](./polymarket-api-reference.md) - Endpoints and payloads
3. Copy [**Code Patterns**](./polymarket-code-patterns.md) - Reusable code snippets
4. Troubleshoot with [**Troubleshooting Guide**](./polymarket-troubleshooting.md) - Common issues

See also: [`.claude/docs/09_polymarket_integration.md`](../.claude/docs/09_polymarket_integration.md) for architecture overview and caching details.
...
- [`.claude/docs/09_polymarket_integration.md`](../.claude/docs/09_polymarket_integration.md) — Architecture overview, caching setup, and database tables

## Documentation Stats

| File | Purpose | When to Use |
|------|---------|-------------|
| **API Reference** | Endpoint documentation | Looking up APIs |
| **Implementation Steps** | How-to guides | Adding sports/apps |
| **Code Patterns** | Reusable algorithms | Writing code |
| **Troubleshooting** | Issue resolution | Something's broken |
...
**Path**: Architecture overview → Implementation Steps → Code Patterns

1. Read [architecture overview](../.claude/docs/09_polymarket_integration.md) for context
...
**Path**: Implementation Steps → Architecture → Code Patterns

1. Follow [New App Integration](./polymarket-implementation-steps.md#integrating-into-a-new-app)
2. Review architecture in [architecture overview](../.claude/docs/09_polymarket_integration.md)
