...
Usage:
  python3 props_backfill.py --slate          # snapshot counts + credit estimate, no API calls
...
MARKETS = ("player_pass_tds,player_pass_yds,player_receptions,player_reception_yds,"
           "player_rush_yds,player_anytime_td,player_pass_attempts,player_pass_completions,"
           "player_rush_attempts")  # 2023 pass fetches all 9 in one call; 2024-25 got 6+3 in two passes
...
def main():
    ...
    g = g[g.season.isin(seasons)].sort_values(["season", "week", "gameday", "gametime"]).reset_index(drop=True)
