...
import { formatMoneyline } from '@/utils/formatting';
...
export function mlbHeadshotUrl(playerId: number): string {
  return `https://content.mlb.com/images/headshots/current/213x213/${playerId}.jpg`;
}
