...
/**
 * Banner displayed at top of NCAAB feed that links to the betting trends page
 */
export function NCAABBettingTrendsBanner() {
  ...
  const handlePress = () => {
    ...
    router.push('/(drawer)/(tabs)/ncaab-betting-trends' as any);
  };
