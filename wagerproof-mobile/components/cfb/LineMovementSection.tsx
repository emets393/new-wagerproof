...
import { fetchLineMovement, LineMovementData } from '@/utils/cfbDataFetchers';
...
export function LineMovementSection({ trainingKey, homeTeam, awayTeam }: LineMovementSectionProps) {
  ...
  const awayTeamColors = getCFBTeamColors(awayTeam);
  const homeTeamColors = getCFBTeamColors(homeTeam);
