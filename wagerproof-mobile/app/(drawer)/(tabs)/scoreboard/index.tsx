...
export default function ScoreboardScreen() {
  ...
  return (
    <View style={[styles.container, { backgroundColor: isDark ? '#000000' : '#ffffff' }]}>
      {/* Native nav-bar chrome — Honeydew MainMealPlanView pattern. */}
      <Stack.Screen
        options={{
      ...
      {/* Scrollable Content — native nav-bar owns the top inset via
          `contentInsetAdjustmentBehavior="automatic"`, no manual paddingTop. */}
      <Animated.ScrollView
