              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="space-y-6">
                  <div className="text-center">
                    ...
                    <h3 className="text-xl font-bold text-green-400 mb-2">WagerProof</h3>
                    <p className="text-sm text-white/60">Professional betting platform</p>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="p-3 bg-green-500/10 rounded-lg border border-green-500/20">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="font-semibold text-green-300">Edge Finder</span>
                      </div>
                    ...
                    <div className="p-3 bg-purple-500/10 rounded-lg border border-purple-500/20">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="font-semibold text-purple-300">AI Game Simulator</span>
                      </div>
                      <ul className="space-y-1 text-sm text-white/70">
                        <li className="flex items-center gap-2">
                    ...
                    <div className="p-3 bg-blue-500/10 rounded-lg border border-blue-500/20">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="font-semibold text-blue-300">Additional Features</span>
                      </div>
                      <ul className="space-y-1 text-sm text-white/70">
                        <li className="flex items-center gap-2">
                ...
                <div className="space-y-6">
                  <div className="text-center">
                    ...
                    <h3 className="text-xl font-bold text-red-400 mb-2">Generic AI Chatbots</h3>
                    <p className="text-sm text-white/60">ChatGPT, Claude, etc.</p>
                  </div>
                  
                  <div className="space-y-4">
                    <div className="p-3 bg-red-500/10 rounded-lg border border-red-500/20">
                      <h4 className="font-semibold text-red-300 mb-2">Limitations</h4>
                      <ul className="space-y-1 text-sm text-white/70">
                ...
                <div className="space-y-6">
                  <div className="text-center">
                    ...
                    <h3 className="text-xl font-bold text-yellow-400 mb-2">Traditional Sportsbooks</h3>
                    <p className="text-sm text-white/60">DraftKings, FanDuel, etc.</p>
                  </div>
                  
                  <div className="space-y-4">
                    <div className="p-3 bg-yellow-500/10 rounded-lg border border-yellow-500/20">
                      <h4 className="font-semibold text-yellow-300 mb-2">What They Offer</h4>
                      <ul className="space-y-1 text-sm text-white/70">
                        <li className="flex items-start gap-2">
              ...
              <div className="mt-8 p-6 bg-white/5 rounded-lg border border-white/10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                  <div className="space-y-2">
                    <h5 className="font-semibold text-green-300">What makes us different:</h5>
                  ...
                  <div className="space-y-2">
                    <h5 className="font-semibold text-blue-300">Your competitive edge:</h5>
                    <ul className="space-y-1 text-white/70">
