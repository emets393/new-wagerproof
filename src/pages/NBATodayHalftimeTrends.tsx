...
import { RefreshCw, AlertCircle, Clock, ArrowLeftRight } from 'lucide-react';
                                    ...
                                    return (
                                      <div className="mt-4 pt-4 border-t border-border space-y-2">
                                        ...
                                        <div className="flex flex-wrap gap-3 text-sm min-w-0">
                                          <div className="inline-flex flex-wrap items-center gap-2 rounded-full bg-muted/60 dark:bg-muted/40 border border-border px-3 py-1.5 min-w-0 max-w-full">
                                            ...
                                            {consensus.twoH.type === 'no_play' ? (
                                              ...
                                              <>
                                                ...
                                                <span className={getLeanCellClassName(consensus.twoH.type === 'heavy' ? 'Heavy' : 'Slight')}>
                                                  {consensus.twoH.type === 'heavy' ? 'Heavy Lean' : 'Slight Lean'} — 2H Line TBD
                                                </span>
                                              </>
                                            )}
                                          </div>
                ...
                return (
                  <li key={`${row.game_id}-${row.team_name}-${i}`} className="flex flex-col gap-1 min-w-0">
                    <div className="flex flex-wrap items-center gap-3 text-sm min-w-0">
                      ...
                      <span className={getPercentageColor(row.lost_both_1h_side_win_pct)}>
                        {pctStr}
                      </span>
