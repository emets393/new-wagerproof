...
public enum AchievementCatalog {
    public static let definitions: [AchievementDefinition] = [
        ...
        .init(id: "agent-squad", title: "Agent Squad", group: .gettingStarted, variantRoot: "AgentSquad", target: 3, requirement: "Create 3 agents."),
        .init(id: "full-lineup", title: "Full Lineup", group: .gettingStarted, variantRoot: "FullLineup", target: 5, requirement: "Create 5 agents."),
        ...
        .init(id: "experience-1000", title: "1,000 Graded Picks", group: .experience, variantRoot: "Experience1000", target: 1000, requirement: "Have one of your agents reach 1,000 graded picks."),
        .init(id: "experience-2500", title: "2,500 Graded Picks", group: .experience, variantRoot: "Experience2500", target: 2500, requirement: "Have one of your agents reach 2,500 graded picks."),
        .init(id: "experience-5000", title: "5,000 Graded Picks", group: .experience, variantRoot: "Experience5000", target: 5000, requirement: "Have one of your agents reach 5,000 graded picks."),
        ...
        .init(id: "streak-20", title: "20 Win Streak", group: .streaks, variantRoot: "Streak20", target: 20, requirement: "Have one agent win 20 consecutive straight picks."),
        .init(id: "streak-25", title: "25 Win Streak", group: .streaks, variantRoot: "Streak25", target: 25, requirement: "Have one agent win 25 consecutive straight picks."),
        ...
        .init(id: "plus-50-units", title: "+50 Units", group: .performance, variantRoot: "Plus50Units", target: 50, requirement: "Have one agent reach +50 net units."),
        .init(id: "plus-100-units", title: "+100 Units", group: .performance, variantRoot: "Plus100Units", target: 100, requirement: "Have one agent reach +100 net units."),
        ...
        .init(id: "consistent-250", title: "Proven Consistency 250", group: .performance, variantRoot: "Consistent250", target: 55, requirement: "Reach a 55% win rate with at least 250 decided picks on one agent."),
        .init(id: "consistent-500", title: "Proven Consistency 500", group: .performance, variantRoot: "Consistent500", target: 55, requirement: "Reach a 55% win rate with at least 500 decided picks on one agent."),
