...
// paths only: these slates are frozen 2025 data and would filter to nothing.
...
// nflverse scheme — the same abbrs the slate game_id embeds ({season}_{wk}_{AWAY}_{HOME}).
