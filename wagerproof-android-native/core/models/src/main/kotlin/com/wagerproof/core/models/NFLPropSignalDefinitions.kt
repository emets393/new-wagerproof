 ...
 * Strings copied verbatim from the iOS source.
 */
data class NFLPropSignalDefinition(
    val id: String,
    val displayName: String,
    val oneLiner: String,
    val definition: String,
    val whyItWorks: String,
    val betDirection: String,
    val typicalHit: String? = null,
    /** P6 and similar rules that tell the bettor to avoid the market. */
    val isAntiSignal: Boolean = false,
)

object NFLPropSignalDefinitions {
    private val catalog: Map<String, NFLPropSignalDefinition> = mapOf(
        "P1" to NFLPropSignalDefinition(
            id = "P1",
        ...
        "P10" to NFLPropSignalDefinition(
            id = "P10",
        ...
        "P12" to NFLPropSignalDefinition(
            id = "P12",
        ...
        "P13" to NFLPropSignalDefinition(
            id = "P13",
        ...
        "P14" to NFLPropSignalDefinition(
            id = "P14",
        ...
        "P15" to NFLPropSignalDefinition(
            id = "P15",
        ...
        "P16" to NFLPropSignalDefinition(
            id = "P16",
        ...
        "P17" to NFLPropSignalDefinition(
            id = "P17",
        ...
        "P18" to NFLPropSignalDefinition(
            id = "P18",
    ...
    fun definition(flag: String): NFLPropSignalDefinition? = catalog[flag.uppercase()]

    fun resolve(flags: List<String>): List<NFLPropSignalDefinition> =
        flags.mapNotNull { definition(it) }
}
