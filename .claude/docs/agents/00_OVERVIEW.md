...
- [18_GENERATION_V3_TRIGGERDEV.md](./18_GENERATION_V3_TRIGGERDEV.md) - Parallel native-client V3 execution path on Trigger.dev with live run metadata
- [11_PUSH_NOTIFICATIONS.md](./11_PUSH_NOTIFICATIONS.md) - Push notifications for agent auto-pick readiness
