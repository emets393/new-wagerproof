...
import { footballWeekFinalDate } from "../../shared/dateUtils.ts";
...
export async function submitParlay(
  ...
  // Week-long runs allow 6-leg tickets (vs the daily hard cap of 4). Weekly
  // runs execute only on the Trigger.dev path; here window is always 'day',
  // but the logic stays parallel with agents-v3's copy.
