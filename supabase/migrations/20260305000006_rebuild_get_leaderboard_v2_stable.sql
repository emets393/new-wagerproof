-- ============================================================================
-- Migration: Rebuild get_leaderboard_v2 with stable execution
-- Description:
--   - Fixes runtime SQL errors in all_time and rolling timeframe branches
--   - Preserves the response contract and server-side deterministic sorting
-- ============================================================================
